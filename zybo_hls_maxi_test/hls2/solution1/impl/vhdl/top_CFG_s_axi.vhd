...
architecture behave of top_CFG_s_axi is
    ...
    constant ADDR_VALUES_DATA_0 : INTEGER := 16#10#;
    constant ADDR_VALUES_CTRL   : INTEGER := 16#14#;
    ...
    signal int_values          : UNSIGNED(31 downto 0) := (others => '0');
